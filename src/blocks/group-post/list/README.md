...
- 목록 mock은 `src/blocks/group-post/mock.ts`의 raw group/post 데이터를 source of truth로 사용한다.
...
2. 목록 길이나 밀도 실험은 `mock.scenarios.ts`에서 raw override 후 projection을 다시 계산한다.
